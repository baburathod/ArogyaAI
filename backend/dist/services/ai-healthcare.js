...
export const AIHealthcare = {
     ...
     */
    generateWellnessReport: async (userId) => {
        try {
            ...
            const latestRiskAssessment = recentRecords.find((r) => r.data.riskScore);
            ...
            return {
                ...
                latestRiskScore: latestRiskAssessment ? latestRiskAssessment.data.riskScore : 'N/A',
